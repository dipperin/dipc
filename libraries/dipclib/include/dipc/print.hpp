...
#ifdef ENABLE_TRACE
#define TRACE(...) dipc::println("file", __FILE__, "func", __func__, "line", __LINE__, ##__VA_ARGS__)
#else
#define TRACE(...)
#endif

#ifdef ENABLE_TRACE
#define DEBUG(...) dipc::println("file", __FILE__, "func", __func__, "line", __LINE__, ##__VA_ARGS__)
#else
#define DEBUG(...)  dipc::println(__VA_ARGS__)
#endif
