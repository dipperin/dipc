if (DIPC_CDT_ROOT STREQUAL "" OR NOT DIPC_CDT_ROOT)
  set(DIPC_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${DIPC_CDT_ROOT}/lib/cmake/dipc.cdt)
...
function(DIPC_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
  set(${output} "INVALID" PARENT_SCOPE)

  EXTRACT_MARJOR_MINOR_FROM_VERSION("${version}" success major minor)
  if (NOT success)
    if (${ARGC} GREATER 5)
  ...
  if ("${major}.${minor}" VERSION_LESS "${hard_min_major}.${hard_min_minor}")
    ...
    if (${ARGC} GREATER 5)
      set(${ARGV5} "version '${version}' does not meet hard minimum version reqiurement of ${hard_min_major}.${hard_min_minor}" PARENT_SCOPE)
    endif()
    return()
  endif()
  ...
  if ("${major}.${minor}" VERSION_LESS "${soft_max_major}.${soft_max_minor}")
...
endfunction(DIPC_CHECK_VERSION)
